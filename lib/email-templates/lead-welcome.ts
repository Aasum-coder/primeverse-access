...
export function buildLeadWelcomeEmail({ leadName, distributorName, referralLink, lang = 'en' }: LeadWelcomeOptions) {
  ...
  const content = `
    ...
    <p style="color:#D4A843;font-size:14px;font-weight:600;letter-spacing:0.05em;text-transform:uppercase;margin:0 0 16px;">
    ...
    <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="margin-bottom:20px;">
      <tr>
        <td style="padding:14px 16px;background:#1A1A2E;border-left:3px solid #D4A843;border-radius:0 6px 6px 0;">
    ...
    <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="margin-bottom:20px;">
      <tr>
        <td style="padding:14px 16px;background:#1A1A2E;border-left:3px solid #888;border-radius:0 6px 6px 0;">
    ...
    <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="margin-bottom:28px;">
      <tr>
        <td style="padding:14px 16px;background:#1A1A2E;border-left:3px solid #555;border-radius:0 6px 6px 0;">
    ...
    <div style="border-top:1px solid rgba(212,168,67,0.2);padding-top:20px;margin-top:8px;">
      <p style="color:#999;font-size:13px;line-height:1.5;margin:0 0 4px;">
        Any questions? Contact <strong style="color:#D4A843;">${distributorName}</strong>.
      </p>
