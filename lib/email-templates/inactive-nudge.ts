...
const translations: Record<string, InactiveNudgeTranslation> = {
  en: {
    ...
    body_intro_7: "It's been <span style=\"color:#D4A843;font-weight:700;\">{days}</span> days since you last checked your dashboard. No worries — your landing page has been live and working the entire time.",
    ...
    body_intro_14: "It's been <span style=\"color:#D4A843;font-weight:700;\">{days}</span> days since your last visit. Your landing page is still live at <a href=\"https://www.primeverseaccess.com/{slug}\" style=\"color:#D4A843;text-decoration:none;font-weight:600;\">primeverseaccess.com/{slug}</a> — and it's still ready to bring in leads for you.",
    ...
    has_leads_body: 'People signed up through your page while you were gone! Log in to check who they are and submit their UIDs.',
  ...
  no: {
    ...
    body_intro_7: 'Det har gått <span style="color:#D4A843;font-weight:700;">{days}</span> dager siden du sist sjekket dashboardet ditt. Ingen bekymring — landingssiden din har vært aktiv og fungert hele tiden.',
    ...
    body_intro_14: 'Det har gått <span style="color:#D4A843;font-weight:700;">{days}</span> dager siden ditt siste besøk. Landingssiden din er fortsatt aktiv på <a href="https://www.primeverseaccess.com/{slug}" style="color:#D4A843;text-decoration:none;font-weight:600;">primeverseaccess.com/{slug}</a> — og den er fortsatt klar til å bringe inn leads for deg.',
    ...
    has_leads_body: 'Folk registrerte seg via siden din mens du var borte! Logg inn for å sjekke hvem de er og sende inn UID-ene deres.',
  ...
  sv: {
    ...
    body_intro_7: 'Det har gått <span style="color:#D4A843;font-weight:700;">{days}</span> dagar sedan du senast kollade din dashboard. Inga problem — din landningssida har varit aktiv och fungerat hela tiden.',
    ...
    body_intro_14: 'Det har gått <span style="color:#D4A843;font-weight:700;">{days}</span> dagar sedan ditt senaste besök. Din landningssida är fortfarande aktiv på <a href="https://www.primeverseaccess.com/{slug}" style="color:#D4A843;text-decoration:none;font-weight:600;">primeverseaccess.com/{slug}</a> — och den är fortfarande redo att ta in leads åt dig.',
    ...
    has_leads_body: 'Folk registrerade sig via din sida medan du var borta! Logga in för att kolla vilka de är och skicka in deras UIDs.',
  ...
  es: {
    ...
    body_intro_7: 'Han pasado <span style="color:#D4A843;font-weight:700;">{days}</span> días desde que revisaste tu panel por última vez. No te preocupes — tu página de aterrizaje ha estado activa y funcionando todo el tiempo.',
    ...
    body_intro_14: 'Han pasado <span style="color:#D4A843;font-weight:700;">{days}</span> días desde tu última visita. Tu página de aterrizaje sigue activa en <a href="https://www.primeverseaccess.com/{slug}" style="color:#D4A843;text-decoration:none;font-weight:600;">primeverseaccess.com/{slug}</a> — y sigue lista para traerte leads.',
    ...
    has_leads_body: '¡Personas se registraron a través de tu página mientras estabas ausente! Inicia sesión para ver quiénes son y enviar sus UIDs.',
  ...
  ru: {
    ...
    body_intro_7: 'Прошло <span style="color:#D4A843;font-weight:700;">{days}</span> дней с тех пор, как вы последний раз заходили в дашборд. Не переживайте — ваша лендинг-страница была активна и работала всё это время.',
    ...
    body_intro_14: 'Прошло <span style="color:#D4A843;font-weight:700;">{days}</span> дней с вашего последнего визита. Ваша лендинг-страница по-прежнему активна на <a href="https://www.primeverseaccess.com/{slug}" style="color:#D4A843;text-decoration:none;font-weight:600;">primeverseaccess.com/{slug}</a> — и она по-прежнему готова привлекать лидов для вас.',
    ...
    has_leads_body: 'Люди зарегистрировались через вашу страницу, пока вас не было! Войдите, чтобы узнать, кто они, и отправить их UID.',
  ...
  ar: {
    ...
    body_intro_7: 'مرّ <span style="color:#D4A843;font-weight:700;">{days}</span> يوم منذ آخر مرة تفقدت فيها لوحة التحكم. لا تقلق — صفحتك كانت نشطة وتعمل طوال الوقت.',
    ...
    body_intro_14: 'مرّ <span style="color:#D4A843;font-weight:700;">{days}</span> يوم منذ آخر زيارة لك. صفحتك لا تزال نشطة على <a href="https://www.primeverseaccess.com/{slug}" style="color:#D4A843;text-decoration:none;font-weight:600;">primeverseaccess.com/{slug}</a> — ولا تزال جاهزة لجلب العملاء لك.',
    ...
    has_leads_body: 'أشخاص سجّلوا عبر صفحتك أثناء غيابك! سجّل دخولك لمعرفة من هم وإرسال أرقام UID الخاصة بهم.',
  ...
  tl: {
    ...
    body_intro_7: '<span style="color:#D4A843;font-weight:700;">{days}</span> araw na ang nakalipas mula nang huling check mo sa dashboard mo. Huwag mag-alala — ang landing page mo ay naging live at gumagana buong oras.',
    ...
    body_intro_14: '<span style="color:#D4A843;font-weight:700;">{days}</span> araw na mula nang huling bisita mo. Ang landing page mo ay live pa rin sa <a href="https://www.primeverseaccess.com/{slug}" style="color:#D4A843;text-decoration:none;font-weight:600;">primeverseaccess.com/{slug}</a> — at handa pa ring mag-bring in ng leads para sa iyo.',
    ...
    has_leads_body: 'May nag-sign up sa page mo habang wala ka! Mag-log in para malaman kung sino sila at i-submit ang UIDs nila.',
  ...
  pt: {
    ...
    body_intro_7: 'Faz <span style="color:#D4A843;font-weight:700;">{days}</span> dias desde que você checou seu painel pela última vez. Sem preocupações — sua landing page esteve ativa e funcionando o tempo todo.',
    ...
    body_intro_14: 'Faz <span style="color:#D4A843;font-weight:700;">{days}</span> dias desde sua última visita. Sua landing page ainda está ativa em <a href="https://www.primeverseaccess.com/{slug}" style="color:#D4A843;text-decoration:none;font-weight:600;">primeverseaccess.com/{slug}</a> — e ainda está pronta para trazer leads para você.',
    ...
    has_leads_body: 'Pessoas se cadastraram através da sua página enquanto você esteve fora! Faça login para ver quem são e enviar os UIDs deles.',
  ...
  th: {
    ...
    body_intro_7: 'ผ่านมา <span style="color:#D4A843;font-weight:700;">{days}</span> วันแล้วตั้งแต่คุณตรวจสอบแดชบอร์ดครั้งล่าสุด ไม่ต้องกังวล — แลนดิ้งเพจของคุณยังคงใช้งานได้และทำงานตลอดเวลา',
    ...
    body_intro_14: 'ผ่านมา <span style="color:#D4A843;font-weight:700;">{days}</span> วันแล้วตั้งแต่การเยี่ยมชมครั้งล่าสุด แลนดิ้งเพจของคุณยังคงใช้งานอยู่ที่ <a href="https://www.primeverseaccess.com/{slug}" style="color:#D4A843;text-decoration:none;font-weight:600;">primeverseaccess.com/{slug}</a> — และยังคงพร้อมนำ lead เข้ามาให้คุณ',
    ...
    has_leads_body: 'มีคนลงทะเบียนผ่านหน้าเว็บของคุณขณะที่คุณไม่อยู่! เข้าสู่ระบบเพื่อดูว่าเป็นใครและส่ง UID ของพวกเขา',
...
<p style="color:#D4A843;font-size:11px;font-weight:700;letter-spacing:2px;margin:0 0 12px;text-align:center;text-transform:uppercase;">${t.while_away_label}</p>

<!-- New leads count box -->
<table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="margin:0 0 16px;">
  <tr>
    <td align="center">
      <table role="presentation" cellpadding="0" cellspacing="0" border="0" style="background-color:#0F0F23;border:2px solid #D4A843;border-radius:12px;width:180px;">
        <tr>
          <td style="padding:20px 24px;text-align:center;">
            <p style="color:#D4A843;font-size:48px;font-weight:800;margin:0;line-height:1;">${newLeadsSince}</p>
            <p style="color:#D4A843;font-size:11px;font-weight:700;letter-spacing:2px;margin:8px 0 0;text-transform:uppercase;">${t.new_leads_label}</p>
          </td>
        </tr>
      </table>
    </td>
...
<p style="color:#E0E0E0;font-size:15px;line-height:1.6;margin:0 0 24px;text-align:${textAlign};">${t.has_leads_body}</p>`
  ...
  const content = `
<!-- Heading -->
<h1 style="color:#D4A843;font-size:24px;margin:0 0 16px;text-align:center;font-weight:700;">${heading}</h1>
...
<table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="margin:0 0 20px;">
  <tr>
    <td style="padding:6px 0;color:#E0E0E0;font-size:15px;line-height:1.6;text-align:${textAlign};">
      <span style="color:#D4A843;font-weight:700;">${isRtl ? '←' : '→'}</span>&nbsp; ${t.tip_1}
    </td>
  </tr>
  <tr>
    <td style="padding:6px 0;color:#E0E0E0;font-size:15px;line-height:1.6;text-align:${textAlign};">
      <span style="color:#D4A843;font-weight:700;">${isRtl ? '←' : '→'}</span>&nbsp; ${t.tip_2}
    </td>
  </tr>
  <tr>
    <td style="padding:6px 0;color:#E0E0E0;font-size:15px;line-height:1.6;text-align:${textAlign};">
      <span style="color:#D4A843;font-weight:700;">${isRtl ? '←' : '→'}</span>&nbsp; ${t.tip_3}
    </td>
  </tr>
</table>
