...
export function buildBroadcastEmail({ title, message, distributorName }: BroadcastEmailOptions) {
  ...
  const content = `
<!-- Heading -->
<h1 style="color:#c9a84c;font-size:24px;margin:0 0 20px;text-align:left;font-weight:700;">${title}</h1>

<!-- Message body -->
<p style="color:#E0E0E0;font-size:15px;line-height:1.7;margin:0 0 28px;text-align:left;">${htmlMessage}</p>

<!-- Sign-off -->
<p style="color:#c9a84c;font-size:15px;font-weight:700;margin:0 0 8px;text-align:left;">— ${distributorName}</p>
