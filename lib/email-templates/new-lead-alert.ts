...
const translations: Record<string, NewLeadAlertTranslation> = {
  en: {
    ...
    action_2: "Follow up personally — leads are auto-verified once KYC is approved",
  ...
  no: {
    ...
    action_2: 'Følg opp personlig — leads verifiseres automatisk når KYC er godkjent',
  ...
  sv: {
    ...
    action_2: 'Följ upp personligen — leads verifieras automatiskt när KYC är godkänt',
  ...
  es: {
    ...
    action_2: 'Haz seguimiento personal — los leads se verifican automáticamente cuando se aprueba el KYC',
  ...
  ru: {
    ...
    action_2: 'Свяжитесь лично — лиды верифицируются автоматически после одобрения KYC',
  ...
  ar: {
    ...
    action_2: 'تابع شخصياً — يتم التحقق من العملاء تلقائياً بمجرد الموافقة على KYC',
  ...
  tl: {
    ...
    action_2: 'Mag-follow up personally — awtomatikong na-verify ang leads kapag naaprubahan ang KYC',
  ...
  pt: {
    ...
    action_2: 'Faça follow-up pessoal — os leads são verificados automaticamente quando o KYC é aprovado',
  ...
  th: {
    ...
    action_2: 'ติดตามส่วนตัว — leads จะได้รับการยืนยันอัตโนมัติเมื่อ KYC ได้รับการอนุมัติ',
      ...
      <table role="presentation" cellpadding="0" cellspacing="0" border="0" style="background-color:#0F0F23;border:2px solid #c9a84c;border-radius:10px;width:200px;">
        <tr>
          <td style="padding:20px 24px;text-align:center;">
            <p style="color:#c9a84c;font-size:11px;font-weight:700;letter-spacing:2px;margin:0 0 8px;text-transform:uppercase;">${t.total_leads_label}</p>
            <p style="color:#c9a84c;font-size:52px;font-weight:800;margin:0;line-height:1;">${leadCount}</p>
          </td>
        </tr>
      </table>
    </td>
