...
export default function DistributorPage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  if (notFound) return <div style={{ background: '#080808', minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center' }}><div style={{ color: '#7a7a72', textAlign: 'center' }}><div style={{ color: '#c9a84c', fontSize: '2rem', marginBottom: '1rem' }}>✦</div><p>This page is not available yet.</p><p style={{ fontSize: '0.78rem', marginTop: '0.5rem', color: '#555' }}>The representative may not have set up their profile yet.</p></div></div>
