...
const T: Record<LangKey, Record<string, string>> = {
  ...
  tl: {
    ...
    about_h2: 'Education-First Trading Ecosystem',
    about_p1: 'Ang PrimeVerse ay isang premium na trading education platform na ginawa para sa mga seryosong kalahok. Nagbibigay kami ng structured na mga learning path, professional-grade na mga tool, at curated na broker access.',
    about_p2: 'Ang mga miyembro ay nakakakuha ng access sa live sessions kasama ang mga bihasang trader at proprietary na educational frameworks.',
    about_p3: 'Ang aming komunidad ay binuo sa transparency, edukasyon, at sustainable na paglago.',
    ...
    risk_label: 'Risk Disclaimer',
    risk_text: 'Ang pag-trade ng mga financial instrument kabilang ang forex, CFDs, at derivatives ay may mataas na antas ng panganib at maaaring hindi angkop para sa lahat ng investor. Maaari kang mawalan ng higit pa sa iyong paunang puhunan. Ang nakaraang performance ay hindi nagpapahiwatig ng mga resulta sa hinaharap.',
