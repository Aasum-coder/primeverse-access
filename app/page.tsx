...
const translations: Record<string, Record<string, string>> = {
  en: {
    ...
    visitorsError: 'Could not load visitor analytics',
    visitorsTotal90Days: 'Total visits (90 days)',
    visitorsUniqueCountries: 'Unique countries',
    visitorsTop10Countries: 'Top 10 countries',
    visitorsNoneYet: 'No visits yet.',
    visitorsPerIB: 'Per IB',
    visitorsNoIBActivity: 'No IB activity yet.',
    visitorsTableIB: 'IB',
    visitorsTableVisits: 'Visits',
    visitorsTableTopCountry: 'Top country',
    ...
    wfClose: 'Close',
    telegram_placeholder: 'Telegram username (@username)',
  ...
  no: {
    ...
    visitorsTab: 'Besøk',
    visitorsLoading: 'Laster…',
    visitorsError: 'Kunne ikke laste besøksstatistikk',
    visitorsTotal90Days: 'Totalt besøk (90 dager)',
    visitorsUniqueCountries: 'Unike land',
    visitorsTop10Countries: 'Topp 10 land',
    visitorsNoneYet: 'Ingen besøk ennå.',
    visitorsPerIB: 'Per IB',
    visitorsNoIBActivity: 'Ingen IB-aktivitet ennå.',
    visitorsTableIB: 'IB',
    visitorsTableVisits: 'Besøk',
    visitorsTableTopCountry: 'Topp land',
    ...
    wfClose: 'Lukk',
    telegram_placeholder: 'Telegram brukernavn (@brukernavn)',
  ...
  sv: {
    ...
    visitorsTab: 'Besök',
    visitorsLoading: 'Laddar…',
    visitorsError: 'Kunde inte ladda besöksstatistik',
    visitorsTotal90Days: 'Totalt antal besök (90 dagar)',
    visitorsUniqueCountries: 'Unika länder',
    visitorsTop10Countries: 'Topp 10 länder',
    visitorsNoneYet: 'Inga besök än.',
    visitorsPerIB: 'Per IB',
    visitorsNoIBActivity: 'Ingen IB-aktivitet än.',
    visitorsTableIB: 'IB',
    visitorsTableVisits: 'Besök',
    visitorsTableTopCountry: 'Topp land',
    ...
    wfClose: 'Stäng',
    telegram_placeholder: 'Telegram användarnamn (@användarnamn)',
  ...
  es: {
    ...
    visitorsTab: 'Visitas',
    visitorsLoading: 'Cargando…',
    visitorsError: 'No se pudo cargar la analítica de visitas',
    visitorsTotal90Days: 'Visitas totales (90 días)',
    visitorsUniqueCountries: 'Países únicos',
    visitorsTop10Countries: 'Top 10 países',
    visitorsNoneYet: 'Aún no hay visitas.',
    visitorsPerIB: 'Por IB',
    visitorsNoIBActivity: 'Aún no hay actividad de IBs.',
    visitorsTableIB: 'IB',
    visitorsTableVisits: 'Visitas',
    visitorsTableTopCountry: 'País principal',
    ...
    wfClose: 'Cerrar',
    telegram_placeholder: 'Usuario de Telegram (@usuario)',
  ...
  ru: {
    ...
    visitorsLoading: 'Загрузка…',
    visitorsError: 'Не удалось загрузить статистику посещений',
    visitorsTotal90Days: 'Всего посещений (90 дней)',
    visitorsUniqueCountries: 'Уникальные страны',
    visitorsTop10Countries: 'Топ-10 стран',
    visitorsNoneYet: 'Посещений пока нет.',
    visitorsPerIB: 'По IB',
    visitorsNoIBActivity: 'Активности IB пока нет.',
    visitorsTableIB: 'IB',
    visitorsTableVisits: 'Посещения',
    visitorsTableTopCountry: 'Топ-страна',
    ...
    wfClose: 'Закрыть',
    telegram_placeholder: 'Имя пользователя Telegram (@имя_пользователя)',
  ...
  ar: {
    ...
    visitorsTab: 'الزوار',
    visitorsLoading: 'جارٍ التحميل…',
    visitorsError: 'تعذر تحميل تحليلات الزوار',
    visitorsTotal90Days: 'إجمالي الزيارات (90 يومًا)',
    visitorsUniqueCountries: 'الدول الفريدة',
    visitorsTop10Countries: 'أعلى 10 دول',
    visitorsNoneYet: 'لا توجد زيارات بعد.',
    visitorsPerIB: 'حسب الوكيل',
    visitorsNoIBActivity: 'لا يوجد نشاط للوكلاء بعد.',
    visitorsTableIB: 'وكيل',
    visitorsTableVisits: 'الزيارات',
    visitorsTableTopCountry: 'الدولة الأعلى',
    ...
    wfClose: 'إغلاق',
    telegram_placeholder: 'اسم مستخدم Telegram (@اسم_المستخدم)',
  ...
  tl: {
    ...
    visitorsLoading: 'Naglo-load…',
    visitorsError: 'Hindi ma-load ang analytics ng bisita',
    visitorsTotal90Days: 'Kabuuang bisita (90 araw)',
    visitorsUniqueCountries: 'Mga natatanging bansa',
    visitorsTop10Countries: 'Top 10 bansa',
    visitorsNoneYet: 'Wala pang bisita.',
    visitorsPerIB: 'Bawat IB',
    visitorsNoIBActivity: 'Wala pang aktibidad ang IB.',
    visitorsTableIB: 'IB',
    visitorsTableVisits: 'Bisita',
    visitorsTableTopCountry: 'Nangungunang bansa',
  ...
  pt: {
    ...
    visitorsLoading: 'Carregando…',
    visitorsError: 'Não foi possível carregar a análise de visitantes',
    visitorsTotal90Days: 'Total de visitas (90 dias)',
    visitorsUniqueCountries: 'Países únicos',
    visitorsTop10Countries: 'Top 10 países',
    visitorsNoneYet: 'Ainda não há visitas.',
    visitorsPerIB: 'Por IB',
    visitorsNoIBActivity: 'Ainda não há atividade de IB.',
    visitorsTableIB: 'IB',
    visitorsTableVisits: 'Visitas',
    visitorsTableTopCountry: 'País principal',
    ...
    wfClose: 'Fechar',
    telegram_placeholder: 'Usuário do Telegram (@usuário)',
  ...
  th: {
    ...
    visitorsLoading: 'กำลังโหลด…',
    visitorsError: 'ไม่สามารถโหลดสถิติผู้เข้าชมได้',
    visitorsTotal90Days: 'จำนวนการเข้าชมทั้งหมด (90 วัน)',
    visitorsUniqueCountries: 'ประเทศที่ไม่ซ้ำ',
    visitorsTop10Countries: '10 ประเทศอันดับสูงสุด',
    visitorsNoneYet: 'ยังไม่มีการเข้าชม',
    visitorsPerIB: 'ตาม IB',
    visitorsNoIBActivity: 'ยังไม่มีกิจกรรมของ IB',
    visitorsTableIB: 'IB',
    visitorsTableVisits: 'การเข้าชม',
    visitorsTableTopCountry: 'ประเทศอันดับสูงสุด',
    ...
    wfClose: 'ปิด',
    telegram_placeholder: 'ชื่อผู้ใช้ Telegram (@ชื่อผู้ใช้)',
  ...
  const addLead = async () => {
    ...
    if (insertedLead?.id) {
      ...
      try {
        ...
        // Non-fatal — IB or admin can re-trigger via the dashboard.
      }
    }
      ...
      <div className="dash-wrap" id="main-content" style={impersonating ? { paddingTop: 40 } : undefined}>
        ...
        <header className="dash-header">
          ...
          <div className="header-actions">
            ...
            {(distributor?.is_admin || distributor?.email === 'bitaasum@gmail.com') && (
        ...
        {activeTab === 'visitors' && (
          <div role="tabpanel" id="tab-panel-visitors" aria-labelledby="tab-visitors" style={{ paddingTop: '0.5rem' }}>
            {/* `t` is typed Record<string, string> at the parent level; the
                component declares a structural type with named keys. The cast
                is safe because every key referenced by VisitorAnalytics is
                added to all 9 language blocks in the translations object. */}
            <VisitorAnalytics t={t as unknown as Parameters<typeof VisitorAnalytics>[0]['t']} />
          </div>
        )}
