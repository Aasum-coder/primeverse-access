...
const translations: Record<string, Record<string, string>> = {
  en: {
    ...
    waiting_for_code_subtitle: "After you add the forwarding address, the confirmation email is auto-forwarded to your inbox — check there for a mail with subject '🔐 Confirm forwarding'. The code/link also appears here within 30 seconds.",
    check_now: 'Check now',
  ...
  no: {
    ...
    waiting_for_code_subtitle: 'Etter at du legger til videresendingsadressen, sendes bekreftelses-e-posten automatisk til innboksen din — sjekk der etter en mail med emnet "🔐 Bekreft videresending". Koden/lenken vises også her innen 30 sekunder.',
    check_now: 'Sjekk nå',
          ...
          <div className="profile-grid" role="tabpanel" id="tab-panel-profile" aria-labelledby="tab-profile">
            ...
            <div>
              ...
              <div className="field-group" style={{ border: '1px solid rgba(201,168,76,0.15)', borderRadius: 14, padding: '1.25rem', background: 'rgba(201,168,76,0.03)' }}>
                ...
                {/* Warning banner */}
                <div style={{ padding: '10px 14px', marginBottom: '1rem', borderRadius: 10, border: '1px solid rgba(201,168,76,0.4)', background: 'rgba(201,168,76,0.06)', fontSize: '0.82rem', lineHeight: 1.6, color: '#c9a84c' }}>
                  ⚠️ <strong>Important:</strong> Use the same email address you registered with on PU Prime. If you used a different email for PU Prime, the auto-verification will not work.
                </div>
