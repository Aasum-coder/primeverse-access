...
const translations: Record<string, { subject: string; hi: string; congrats: string; live_at: string; how_to: string; photo_title: string; photo_text: string; bio_title: string; bio_text: string; social_title: string; social_text: string; social_1: string; social_2: string; referral_title: string; referral_text: string; good_luck: string; footer: string }> = {
  ...
  pt: {
    subject: 'Bem-vindo ao 1Move — Sua landing page está no ar!',
    hi: 'Olá',
    congrats: 'Parabéns! Sua landing page pessoal está agora no ar em:',
    live_at: 'Visite sua página',
    how_to: 'Veja como aproveitar ao máximo sua página:',
    photo_title: 'FOTO DE PERFIL',
    photo_text: 'A imagem que você envia no painel se torna a foto de retrato na sua landing page. Use uma foto profissional e clara — é a primeira coisa que os visitantes veem.',
    bio_title: 'BIO',
    bio_text: 'Sua bio é o que torna sua página pessoal. Ela conta aos visitantes quem você é e por que devem confiar em você. Reserve um tempo para escrever algo autêntico que reflita sua experiência e personalidade.',
    social_title: 'LINKS DE REDES SOCIAIS',
    social_text: 'Preencha o máximo de links de redes sociais possível. Isso é importante por dois motivos:',
    social_1: 'Os visitantes verificarão seus perfis sociais para confirmar que você é uma pessoa real e confiável',
    social_2: 'O SYSTM8 usará esses perfis posteriormente para gerar e publicar conteúdo automaticamente para você',
    referral_title: 'LINK DE INDICAÇÃO',
    referral_text: 'Certifique-se de que seu link IB / indicação está correto. Este é o link para o qual os visitantes são redirecionados ao clicar em "Get Access Now" na sua página.',
    good_luck: 'Boa sorte — e bem-vindo à equipe!',
    footer: '© 2025 1Move Academy × PrimeVerse',
  },
  th: {
    subject: 'ยินดีต้อนรับสู่ 1Move — Landing page ของคุณพร้อมใช้แล้ว!',
    hi: 'สวัสดี',
    congrats: 'ยินดีด้วย! Landing page ส่วนตัวของคุณพร้อมใช้แล้วที่:',
    live_at: 'เยี่ยมชมหน้าของคุณ',
    how_to: 'นี่คือวิธีใช้ประโยชน์สูงสุดจากหน้าของคุณ:',
    photo_title: 'รูปโปรไฟล์',
    photo_text: 'รูปที่คุณอัปโหลดในแดชบอร์ดจะกลายเป็นรูปภาพบน landing page ของคุณ ใช้รูปถ่ายที่ชัดเจนและเป็นมืออาชีพ — นี่คือสิ่งแรกที่ผู้เยี่ยมชมเห็น',
    bio_title: 'ไบโอ',
    bio_text: 'ไบโอของคุณคือสิ่งที่ทำให้หน้าเว็บเป็นส่วนตัว บอกผู้เยี่ยมชมว่าคุณเป็นใครและทำไมพวกเขาควรไว้วางใจคุณ ใช้เวลาเขียนสิ่งที่จริงใจสะท้อนความเชี่ยวชาญและบุคลิกภาพของคุณ',
    social_title: 'ลิงก์โซเชียลมีเดีย',
    social_text: 'กรอกลิงก์โซเชียลมีเดียให้มากที่สุด สิ่งนี้สำคัญด้วยสองเหตุผล:',
    social_1: 'ผู้เยี่ยมชมจะตรวจสอบโปรไฟล์โซเชียลของคุณเพื่อยืนยันว่าคุณเป็นบุคคลจริงและน่าเชื่อถือ',
    social_2: 'SYSTM8 จะใช้โปรไฟล์เหล่านี้ในภายหลังเพื่อสร้างและโพสต์เนื้อหาให้คุณโดยอัตโนมัติ',
    referral_title: 'ลิงก์แนะนำ',
    referral_text: 'ตรวจสอบให้แน่ใจว่าลิงก์ IB / แนะนำของคุณถูกต้อง นี่คือลิงก์ที่ผู้เยี่ยมชมจะถูกนำไปเมื่อคลิก "Get Access Now" บนหน้าของคุณ',
    good_luck: 'โชคดี — และยินดีต้อนรับสู่ทีม!',
    footer: '© 2025 1Move Academy × PrimeVerse',
  },
}
