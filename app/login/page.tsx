...
const translations: Record<string, Record<string, string>> = {
  ...
  pt: {
    ...
    signUpLink: "Crie uma aqui",
    signInLink: "Entre aqui",
    backToLogin: "Voltar ao login",
    resetInfo: "Insira seu e-mail e enviaremos um link de redefinição.",
    emailSent: "Verifique sua caixa de entrada para o link de redefinição.",
    ...
    errorEmailInUse: "Este e-mail já está registrado.",
  ...
  th: {
    ...
    signUpLink: "สร้างที่นี่",
    signInLink: "เข้าสู่ระบบที่นี่",
    backToLogin: "กลับไปเข้าสู่ระบบ",
    resetInfo: "กรอกอีเมลของคุณ เราจะส่งลิงก์รีเซ็ตให้",
    emailSent: "ตรวจสอบกล่องจดหมายของคุณสำหรับลิงก์รีเซ็ต",
    signupSuccess: "สร้างบัญชีแล้ว! ตรวจสอบอีเมลเพื่อยืนยัน",
    ...
    errorEmailInUse: "อีเมลนี้ลงทะเบียนแล้ว",
